...
Open In Colab Python PyTorch License

End-to-end semantic segmentation of urban street scenes using a custom DeepLabV3+ architecture with a ResNet-50 backbone, trained on the Cityscapes dataset.
...
🗂️ Dataset
The notebook uses the Cityscapes dataset downloaded via KaggleHub.
...
You need a free Kaggle account and an API token to download the data. See the Kaggle API docs for setup.
